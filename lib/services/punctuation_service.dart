...
class PunctuationService {
  ...
  static final Set<String> tailWords = {
    ...
    'воскликнул', 'воскликнула', 'крикнул', 'крикнула', 'закричал', 'закричала', 'задал', 'задала',
  };
  ...
  static final List<RegExp> questionPatterns = [
    ...
    RegExp(r'\b(ли\s*)$', caseSensitive: false),
  ];
  ...
  static final List<RegExp> exclamationPatterns = [
    ...
    RegExp(r'\b(ах\s+черт|ах\s+чёрт)\b', caseSensitive: false),
  ];
